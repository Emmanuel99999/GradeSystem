        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_AcademicProgram_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_AcademicPeriods_PeriodId",
                        column: x => x.PeriodId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationPlans", x => x.PlanId);
                    table.ForeignKey(
                        name: "FK_EvaluationPlans_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalGrade = table.Column<double>(type: "float(3)", precision: 3, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    Score = table.Column<double>(type: "float(3)", precision: 3, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_EvaluationPlans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationPlans_CourseId",
                table: "EvaluationPlans",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Grades_PlanId",
                table: "Grades",
                column: "PlanId");
